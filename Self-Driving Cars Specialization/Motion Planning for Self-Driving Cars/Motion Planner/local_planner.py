...
class LocalPlanner:
    ...
    def get_goal_state_set(self, goal_index, goal_state, waypoints, ego_state):
        ...
        if goal_index == len(waypoints)-1:
            cur_goal_index = goal_index - 1
        else:
            cur_goal_index = goal_index
		
        delta_x = waypoints[cur_goal_index+1][0] - waypoints[cur_goal_index][0]
        delta_y = waypoints[cur_goal_index+1][1] - waypoints[cur_goal_index][1]
